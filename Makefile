...
examples: examples/median examples/heapsort examples/counter examples/rehash examples/hasht_test
...
examples/hasht_test: examples/hasht_test.c examples/hasht_ii.o | examples/hasht_ii.h
