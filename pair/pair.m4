...
define(`$$pair_mkdef', `dnl
	_set(`PAIRS_DEFINITIONS', `$2_$3', `$1')dnl
...
define(`$$pair_dupdef', `errprint(`Could not create pair<$2, $3> definition $1.', _get(`PAIRS_DEFINITIONS', `$2_$3'), `is already a pair<$2, $3>.')')

define(`PAIR_DEFINITION', `ifdef(`PAIRS_DEFINITIONS[$2_$3]', `indir(`$$pair_dupdef', $@)', `indir(`$$pair_mkdef', `$1', `$2', `$3')')')
