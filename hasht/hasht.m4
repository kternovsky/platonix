...
define(`HASHT_IMPLEMENTATION', `ifelse(indir(`$$hasht_defs', `0', `', `include(_gen/hasht/hasht.c.m4) indir(`$$hasht_pop') $0')'))
divert dnl
')

divert(-1)
dnl PAIR_DEFINITION(`pair_ii',`int',`int')
dnl PAIR_INTERFACE
...
divert dnl
ifelse(translit(indir(`$$hasht_kvp_seq'), ` '), `', `No KVP without pair', `KVP still there D:')
